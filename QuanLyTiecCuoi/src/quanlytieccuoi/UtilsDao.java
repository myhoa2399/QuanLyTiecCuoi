...
//    }
    ...
    public void alertInformationHandler(String strTitle, String content) {
    ...
    public List<OrderDetail> getOrders(String str){
        this.factory = HibernateUtil.getSessionFactory();
        Session session = factory.openSession();
        Criteria cr = session.createCriteria(OrderDetail.class);
        //cr.setParameter("id", str);
//        if(!str.trim().isEmpty())
//            cr.add(Restrictions.like("primaryKey", str));
